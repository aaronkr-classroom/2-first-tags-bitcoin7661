...
<div class = "container py-4">
	...
	<header class = "pb-3 mb-4 border-bottom">
		...
		<svg width = "32" height = "32" fill = "currenColor" class = "bi bi-house
		-fill" viewBox = "0 0 16 16">
		<path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a5.5 0 0 0 .708.708L8
		2.20716  .646  6.647a.5.5 0 0 0 .708-708L13 5.793V2.5a 5.5 0 0 0 0-.5-.5h-
